...
class ChooseOdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox(
          child: Obx(() => oCxt.oddList.isEmpty
                  ...
                  itemBuilder: (context, indx) {
                    return StickyHeader(
                      ...
                      content: GridView.builder(
                        ...
                        itemCount: oCxt
                            .oddList[0].bookmakers[0].bets[indx].values.length,
                        gridDelegate:
                          ...
                          return InkWell(
                            onTap: () {
                              oCxt.selectedOdd.assign(Bets(
                                ...
                                name: oCxt
                                    .oddList[0].bookmakers[0].bets[indx].name,
                                values: [
                                  Values(
                                      odd: oCxt.oddList[0].bookmakers[0]
                                          .bets[indx].values[index].odd,
